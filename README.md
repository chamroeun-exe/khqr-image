...
<div style="display:flex; flex-wrap:wrap; gap:12px; align-items:flex-start;">
  <figure style="margin:0; width:360px; max-width:48%;">
    <a href="vendor/bakong-khqr-image/assets/khqr_khr.png">
      <img src="vendor/bakong-khqr-image/assets/khqr_khr.png" alt="KHQR KHR" style="width:100%; height:auto; border:1px solid #ddd; border-radius:4px;" />
    </a>
    <figcaption style="margin-top:6px; font-size:0.9rem;">
      <a href="vendor/bakong-khqr-image/assets/khqr_khr.png" style="text-decoration:none; background:#0366d6; color:#fff; padding:6px 10px; border-radius:4px; display:inline-block;">View full size</a>
      <a href="vendor/bakong-khqr-image/assets/khqr_khr.png" download style="text-decoration:none; margin-left:8px; border:1px solid #0366d6; color:#0366d6; padding:6px 10px; border-radius:4px; display:inline-block;">Download</a>
    </figcaption>
  </figure>

  <figure style="margin:0; width:360px; max-width:48%;">
    <a href="vendor/bakong-khqr-image/assets/khqr_usd.png">
      <img src="vendor/bakong-khqr-image/assets/khqr_usd.png" alt="KHQR USD" style="width:100%; height:auto; border:1px solid #ddd; border-radius:4px;" />
    </a>
    <figcaption style="margin-top:6px; font-size:0.9rem;">
      <a href="vendor/bakong-khqr-image/assets/khqr_usd.png" style="text-decoration:none; background:#0366d6; color:#fff; padding:6px 10px; border-radius:4px; display:inline-block;">View full size</a>
      <a href="vendor/bakong-khqr-image/assets/khqr_usd.png" download style="text-decoration:none; margin-left:8px; border:1px solid #0366d6; color:#0366d6; padding:6px 10px; border-radius:4px; display:inline-block;">Download</a>
    </figcaption>
  </figure>
</div>
<!-- Pay button: centered and responsive -->
<div style="text-align:center; margin-top:14px;">
  <form action="https://pay.ababank.com/oRF8/2sefrzlj" method="post" style="display:inline-block;">
    <input 
      type="submit" 
      value="Pay me a Tea ☕" 
      style="
